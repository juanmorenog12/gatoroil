...
// Sends every request directly to Gator's email using FormSubmit AJAX.
// The customer stays on the website, including when the page is opened
// inside Instagram, Facebook, Safari, Chrome, or a desktop browser.
...
bookingForm?.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (formStatus) {
      ...
      formStatus.textContent = `We couldn't send the request. Please call or text ${config.phoneDisplay || '(352) 933-5038'}.`;
    }
  } finally {
    if (submitButton) {
